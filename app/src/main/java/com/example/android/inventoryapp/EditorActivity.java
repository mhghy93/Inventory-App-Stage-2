...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentBookUri == null) {
            // This is a new book, so change the app bar to say "Add a Product"
            ...
            // Otherwise this is an existing book, so change app bar to say "Edit Product"
    ...
    /**
     * This method ensures that no field is left blank by the user
     */
